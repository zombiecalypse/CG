...
/**
 * Colours by using two separate colourizers that colour different sides of a
 * plane.
 * 
 * @author aaron
 * 
...
public class LimitColorization extends Colorization {
	...
	public LimitColorization(Colorization low, Colorization high,
			Vector3f limit, float f) {
		this.low = low;
		this.high = high;
		this.limit = limit;

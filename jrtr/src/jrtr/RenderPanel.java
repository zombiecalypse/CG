 ...
 * "renderer"). Currently, this interface is implemented by
 * {@link GLRenderPanel} and {@link SWRenderPanel}.
 */
public interface RenderPanel {

	/**
	 * This is a call-back that needs to be implemented by the user to
